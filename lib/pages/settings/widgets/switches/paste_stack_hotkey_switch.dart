...
class PasteStackHotKeySwitch extends StatelessWidget {
  const PasteStackHotKeySwitch({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocSelector<AppConfigCubit, AppConfigState, HotKey?>(
      selector: (state) {
        return state.config.getPasteStackHotkey;
      },
        ...
        return SwitchListTile(
          ...
          subtitle: Column(
            ...
            children: [
              height4,
              Text(
                context.locale.settings__switch__paste_stack_hotkey__subtitle,
          ...
          onChanged: (value) async {
            ...
            if (!value) {
              await cubit.setPasteStackHotkey(null);
              return;
            }
            ...
            if (hotKey != null) {
              await cubit.setPasteStackHotkey(hotKey);
            }
          },
        );
      },
