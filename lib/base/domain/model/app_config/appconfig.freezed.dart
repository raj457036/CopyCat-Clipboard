...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,themeMode,enableSync,enableFileSync,layout,view,pinned,windowWidth,windowHeight,sortBy,sortOrder,dontUploadOver,dontCopyOver,pausedTill,syncSpeed,toggleHotkey,quickPasteHotkey,pasteStackHotkey,smartPaste,transformAsNewClip,enableTypeToSearch,launchAtStartup,locale,enc2,autoEncrypt,useEncryptionNonce,hideFromScreenCapture,exclusionRules,enableLocalAuth,localAuthTimeoutMinutes,themeColor,themeVariant,showCollectionTip,enableDragNDrop,enablePasteStack,androidBgListener,richDataCapture,lanInstantSync,autoWriteOnReceive,showTrayIcon,onBoardComplete,reviewQualifyingEventCount,lastReviewPromptDate,reviewNeverAsk,lastFocusedWindowId,clockUnSynced]);
