...
// radius
const radius2 = BorderRadius.all(Radius.circular(2));
...
const dockedLRMaxWidth = 280.0;
const dockedLRMinWidth = 260.0;
const dockedTBMaxHeight = 320.0;
const dockedTBMinHeight = 280.0;
